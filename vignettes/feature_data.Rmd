...
```{r}
df_with_rownames = data.frame(row.names = c("feature1", "feature2", "feature3"),
                             sample1 = c(1, 2, 3),
                             sample2 = c(4, 5, 6))
...
A `qSIP_feature_data` object holds validated abundance data for your features. It can be made by giving an already made dataframe, or by modifying a dataframe and piping directly into the function.

```{r}
# option 1
df = data.frame(feature_id = c("feature1", "feature2", "feature3"),
                          sample1 = c(1, 2, 3),
                          sample2 = c(4, 5, 6))
qf1 = qsip_feature_data(df)

# option 2
qf2 = data.frame(feature_id = c("feature1", "feature2", "feature3"),
                          sample1 = c(1, 2, 3),
                          sample2 = c(4, 5, 6)) |>
  qsip_feature_data()
```
...
```{r, eval=FALSE}
tibble(feature_id = c("feature1", "feature2", "feature3"),
                          sample1 = c(1, 2, 3),
                          sample2 = c(4, 5, 6)) |>
  qsip_feature_data()
```
...
```{r}
qf3 = tibble(ASV = c("ASV1", "ASV2", "ASV3"),
                          sample1 = c(1, 2, 3),
                          sample2 = c(4, 5, 6)) |>
...
```{r, error=TRUE}
qf4 = tibble(feature_id = c("feature1", "feature2", "feature3"),
                          sample1 = c(0.1, 0.2, 0.3),
                          sample2 = c(0.4, 0.5, 0.6)) |>
...
```{r}
data.frame(feature_id = c("feature1", "feature2", "feature3"),
                          sample1 = c(1, 2, NA),
                          sample2 = c(4, 5, 6)) |>
...
```{r}
taxonomy = data.frame(feature_id = c("feature1", "feature2", "feature3"),
