...
And although you can plot all together, more than a few objects might make the plots harder to read.

```{r}
#| fig.width: 12
#| fig.height: 8

plot_EAF_values(qsip_list_3,
                error = "ribbon",
                top = 50)
```
