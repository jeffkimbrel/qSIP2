...
test_that("wrong input types fail", {
  expect_error(qsip_data(
    ...
    example_sample_object,
    example_feature_object
  ), "ERROR: source_data should be of class qsip_source_data")
  expect_error(qsip_data(
    example_source_object,
    example_sample_df,
    example_feature_object
  ), "ERROR: sample_data should be of class qsip_sample_data")
  expect_error(qsip_data(
    example_source_object,
    example_sample_object,
    example_feature_df
  ), "ERROR: feature_data should be of class qsip_feature_data")
})
